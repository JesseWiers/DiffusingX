...
from src.pixel_classifier import load_ensemble, compute_iou, compute_dice, predict_labels, save_predictions, save_predictions, pixel_classifier
...
def evaluation(args, models):
    ...
    dice = compute_dice(args, preds, gts)
...
if __name__ == '__main__':
    ...
    if len(opts['steps']) > 0:
        suffix = str(opts['training_number']) + '_'
        suffix += str(opts['testing_number']) + '_'
